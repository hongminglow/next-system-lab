  ...
  return (
    <section className="rounded-md border border-black/10 p-4 text-sm dark:border-white/15">
      <div className="font-semibold">
        Runtime section (excluded from pre-render)
      </div>
      <div className="mt-2">
  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-2xl flex-col gap-4 px-6 py-10">
      ...
      <p className="text-sm text-zinc-700 dark:text-zinc-300">
        With <span className="font-mono">cacheComponents: true</span>, dynamic
        data fetches are kept out of pre-rendered output by default (static
        shell + runtime section). You can opt-in caching for specific parts via{" "}
